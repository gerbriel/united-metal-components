  ...
  public: {
    Tables: {
      ...
      products: {
        ...
        // sort_order defaults to 0 and slug is auto-generated by a DB trigger,
        // so both are optional on insert.
        Insert: Omit<Database['public']['Tables']['products']['Row'], 'id' | 'created_at' | 'updated_at' | 'sort_order' | 'slug'> & { sort_order?: number; slug?: string }
