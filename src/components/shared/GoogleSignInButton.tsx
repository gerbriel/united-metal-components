...
// "Continue with Google" — shared by the login and signup pages. Starts the
// Supabase OAuth PKCE flow; the round-trip lands on /auth/callback, which
// routes staff → dashboard, incomplete profiles → /signup/complete, everyone
// else → /account. First-time Google users are auto-created as customers.
