...
// Fallback used when the DB has no active testimonials yet (e.g. before the
// migration runs) — keeps the section identical to its original hardcoded form.
const DEFAULT_TESTIMONIALS: Pick<Testimonial, 'name' | 'role' | 'company' | 'content' | 'rating'>[] = [
  {
    name: 'Mike Rodriguez',
