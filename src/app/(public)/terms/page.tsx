  ...
  if (termsHtml) {
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="site-content-html text-sm leading-relaxed" dangerouslySetInnerHTML={{ __html: termsHtml }} />
      </div>
    )
  }
      ...
      <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-8">
        ...
        <section>
          ...
          <div className="bg-slate-50 rounded-xl p-5 text-sm text-muted-foreground space-y-1">
            ...
            <p>Phone: <a href="tel:+15595679118" className="text-orange-500 hover:text-orange-600">{PHONE}</a></p>
